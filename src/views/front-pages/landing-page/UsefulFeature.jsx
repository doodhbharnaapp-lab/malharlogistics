...
const feature = [
  {
    ...
    description: 'No hidden fees or surprise charges. Get instant, accurate quotes with detailed cost breakdowns before you commit to shipping.'
  },
  {
    icon: <TransitionUp />,
    title: 'Global Network',
    description: 'Strategic partnerships across 150+ countries ensuring seamless door-to-door delivery anywhere in the world with local expertise.'
  },
  {
    icon: <Edit />,
    title: 'Insurance Coverage',
    description: 'Comprehensive cargo insurance options protecting your shipments against loss, damage, or delays with quick claims processing.'
  },
  {
    icon: <Cube />,
    title: 'Same-Day Delivery',
    description: 'Express services available in major cities with guaranteed delivery within hours for urgent and time-critical shipments.'
  },
  {
    icon: <LifeBuoy />,
  ...
  },
  {
    ...
    description: 'Personalized support from experienced logistics professionals who understand your business needs and provide tailored solutions.'
  }
]
const UsefulFeature = () => {
  // Refs
