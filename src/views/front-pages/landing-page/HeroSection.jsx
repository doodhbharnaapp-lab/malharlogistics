...
const HeroSection = ({ mode }) => {
  ...
  // Image paths
  const dashboardImageLight = 'https://i.ibb.co/nXNJqxD/Chat-GPT-Image-Feb-1-2026-06-51-18-PM.png'
  ...
  return (
    <section
      id='home'
      className='relative overflow-hidden pbs-[70px] -mbs-[70px] bg-backgroundPaper z-[1]'
    >
      {/* Background */}
      ...
      <div className={classnames('pbs-16 overflow-hidden', frontCommonStyles.layoutSpacing)}>
        <div className='md:max-is-[620px] mlb-0 mli-auto text-center'>
          <Typography className='font-extrabold text-primary sm:text-[40px] text-3xl mbe-4 leading-[46px]'>
          ...
          <Typography
            ...
            sx={{ opacity: 0.85 }}
          >
            Malhar Logistics delivers safe, fast, and cost-effective freight services
            with on-time delivery and pan-India coverage.
          </Typography>
          <Stack
      ...
      >
        <Link href='/' aria-label='Malhar Logistics'>
          <img
            src={dashboardImage}
