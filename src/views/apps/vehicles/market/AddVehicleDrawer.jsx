...
const AddVehicleDrawer = ({
    ...
    const {
        ...
        defaultValues: {
            vehicleNo: '',
            vehicleModel: '', // Keep as vehicleModel in form (matches backend check)
            ownerName: '',
            ownerMobile: '',
            driverName: '',
            driverMobile: '',
    ...
    useEffect(() => {
        if (editData && open) {
            console.log('Editing vehicle data:', editData)
            reset({
                vehicleNo: editData.vehicleNo || '',
                vehicleModel: editData.model || editData.vehicleModel || '', // Map model to vehicleModel
                ownerName: editData.ownerName || '',
                ownerMobile: editData.ownerMobile || '',
                driverName: editData.driverName || '',
                driverMobile: editData.driverMobile || '',
    ...
    const onSubmit = async formData => {
        try {
            ...
            if (!formData.vehicleNo || !formData.vehicleModel || !formData.ownerName || !formData.ownerMobile) {
                setError('Vehicle Number, Model, Owner Name and Owner Mobile are required')
                setIsSubmitting(false)
                return
            }
            ...
            const payload = {
                vehicleNo: formData.vehicleNo,
                vehicleModel: formData.vehicleModel, // Send as vehicleModel (matches backend check)
                ownerName: formData.ownerName,
                ownerMobile: formData.ownerMobile,
                driverName: formData.driverName || '',
                driverMobile: formData.driverMobile || '',
