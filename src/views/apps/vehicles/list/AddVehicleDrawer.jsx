...
const AddVehicleDrawer = ({
    ...
    useEffect(() => {
        if (editData && open && owners.length > 0 && drivers.length > 0 && types.length > 0) {
            ...
            // Check if we have manual driver data or selected driver
            let driverMode = 'select'
            let driverId = ''
            let manualDriverName = ''
            let manualDriverMobile = ''
            // Check if there's manual driver data
            if (editData.manualDriver || editData.driverName || editData.driverMobile) {
                driverMode = 'manual'
                manualDriverName = editData.manualDriver?.name || editData.driverName || ''
                manualDriverMobile = editData.manualDriver?.mobile || editData.driverMobile || ''
            }
            // Try to find driver ID for selection mode
            ...
            reset({
                ...
                manualDriverMobile: manualDriverMobile || '',
            ...
            // Set driver mobile if driver found in select mode
            if (driverId && driverMode === 'select') {
