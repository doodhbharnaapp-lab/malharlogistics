...
/* ================= CREATE ADVANCE ================= */
export const POST = checkPermission(PERMISSIONS.advance.CREATE)(
...
/* ================= UPDATE ADVANCE STATUS ================= */
export const PUT = checkPermission(PERMISSIONS.advance.WRITE)(
...
/* ================= DELETE ADVANCE ================= */
export const DELETE = checkPermission(PERMISSIONS.advance.DELETE)(
...
/* ================= BULK MARK AS PAID ================= */
export const POST_BULK_PAID = checkPermission(PERMISSIONS.advance.BULK_UPDATE)(
